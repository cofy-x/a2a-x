            ...
            try {
                ...
                for (String line : lines) {
                    ...
                    if (line.startsWith("data:")) {
                        ...
                        try {
                            SendTaskStreamingResponse streamingResponse = objectMapper.readValue(currentData, SendTaskStreamingResponse.class);
                            ...
                            listener.onError(new A2AClientException("Failed to parse streaming response: " + currentData, e));
                            return;
                        }
                    }
                }
